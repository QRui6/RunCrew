...
- 建立版本化评测与回归体系：单 Agent 确定性 Policy 和真实 DeepSeek 在同一 Suite Hash 下均为12/12，多 Agent 确定性 Harness 基线18/18，覆盖权限、故障恢复、Schema、事实血缘和 stale 审核，项目全量146项自动化测试通过。
...
构建版本化合成评测，单 Agent 确定性 Policy 与真实 DeepSeek 同 Hash 均12/12，多 Agent 确定性 Harness 18/18，全量146项自动化测试通过。
